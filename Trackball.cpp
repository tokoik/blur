...
#define SCALE 6.283185307179586   // マウスの相対位置→回転角の換算係数
...
** 回転変換行列 r <- クォータニオン q
*/
static void qrot(GLfloat r[], double q[])
{
  ...
  r[ 0] = (GLfloat)(1.0 - y2 - z2);
  r[ 1] = (GLfloat)(xy + zw);
  r[ 2] = (GLfloat)(zx - yw);
  r[ 4] = (GLfloat)(xy - zw);
  r[ 5] = (GLfloat)(1.0 - z2 - x2);
  r[ 6] = (GLfloat)(yz + xw);
  r[ 8] = (GLfloat)(zx + yw);
  r[ 9] = (GLfloat)(yz - xw);
  r[10] = (GLfloat)(1.0 - x2 - y2);
...
Trackball::Trackball(void)
{
  ...
  // 回転行列の初期化
  rt[ 0] = 1.0f; rt[ 1] = 0.0f; rt[ 2] = 0.0f; rt[ 3] = 0.0f;
  rt[ 4] = 0.0f; rt[ 5] = 1.0f; rt[ 6] = 0.0f; rt[ 7] = 0.0f;
  rt[ 8] = 0.0f; rt[ 9] = 0.0f; rt[10] = 1.0f; rt[11] = 0.0f;
